...
public class ChatLinkAssociation extends TableImpl<ChatLinkAssociationRecord> {
    ...
    public LinkPath link() {
        if (_link == null) {
            _link = new LinkPath(this, Keys.CHAT_LINK_ASSOCIATION__CHAT_LINK_ASSOCIATION_LINK_ID_FKEY, null);
        }
    ...
    public ChatPath chat() {
        if (_chat == null) {
            _chat = new ChatPath(this, Keys.CHAT_LINK_ASSOCIATION__CHAT_LINK_ASSOCIATION_CHAT_ID_FKEY, null);
        }
