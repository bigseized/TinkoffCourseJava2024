...
import edu.java.dao.repository.jooq.tables.Link.LinkPath;
...
public class Chat extends TableImpl<ChatRecord> {
    ...
    public ChatLinkAssociationPath chatLinkAssociation() {
        if (_chatLinkAssociation == null) {
            _chatLinkAssociation = new ChatLinkAssociationPath(
                this,
                null,
                Keys.CHAT_LINK_ASSOCIATION__CHAT_LINK_ASSOCIATION_CHAT_ID_FKEY.getInverseKey()
            );
        }
    ...
    public LinkPath link() {
        return chatLinkAssociation().link();
    }
